...
from ibm_watson import TextToSpeechV1, text_to_speech_adapter_v1
from ibm_cloud_sdk_core.authenticators import IAMAuthenticator
authenticator = IAMAuthenticator('fZNf9W6CFUOHS6joedzAadEZmjEOuZ2DBjbwhzh2T-SZ')
tts = TextToSpeechV1(authenticator=authenticator)
tts.set_service_url('https://api.us-south.text-to-speech.watson.cloud.ibm.com/instances/82ed0ce7-013b-4921-9e60-cb688f1717d1')
CHUNK = 1024
...
with open('./output.mp3', 'wb') as audio_file:
    res = tts.synthesize('hello how are you!',accept='audio/mp3', voice='en-GB_JamesV3Voice').get_result()
